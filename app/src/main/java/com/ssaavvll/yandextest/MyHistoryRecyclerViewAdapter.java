...
import com.ssaavvll.yandextest.dummy.DummyContent.DummyItem;
...
public class MyHistoryRecyclerViewAdapter extends RecyclerView.Adapter<MyHistoryRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.textFrom);
            mContentView = (TextView) view.findViewById(R.id.textTo);
        }
